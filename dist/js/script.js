...
// data-spollers - родительский блок с спойлерами
// параметры брейкпоинта - width, max/min
// data-one-spoller - означает что может быть открыт 1 сполер
// data-spoller кнопка открытия сполера
  ...
  function setSpollerAction(e) {
    ...
    if (el.hasAttribute('data-spoller') || el.closest('[data-spoller]')) {
      ...
      if (!spollersBlock.querySelectorAll('._slide').length) {
        ...
        spollerTitle.offsetParent.classList.toggle('_active');
